...
/* ============================= SUBQUERIES ====================================
   calisan sayisi 15.000’den cok olan markalarin isimlerini ve bu 
...
==============================================================================*/   
 ...
 -----------------------------------------------------------------------------*/
 select marka_isim, calisan_sayisi, (select round(AVG(maas)) from calisanlar where marka_isim=isyeri) as ort_maas
 from markalar;
