/*======================= CONSTRAINTS - KISITLAMALAR ======================================
    ...
    FOREIGN KEY - Başka bir tablodaki Primary Key’i referans göstermek için kullanılır. 
                  ...
                  foreign ve primary ile tablolar birbirine bağlamadan da, id leri ayni 
                  olan satirlarda işlem yap diyebiliriz, böylelikle
...
/*----------------------------------------------------------------*/
    ...
    drop table calisanlar;-- baglantili tablolarda child silinmeden parent silinmez
