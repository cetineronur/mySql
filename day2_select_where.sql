...
/*-----------------------------------------------------------------------------
 ...
 /*======================= SELECT - BETWEEN ==================================*/ 
    ...
    -- not: BEETWEEN iki mantiksal ifade ile tanimlayabilieceginiz durumlari tek komutla yazabilme imkani verir.alter
...
/* ========================================================================== */
-- ORNEK9: ISMI a HARFI ILA BASLAYANLAR LISTELEYINIZ
...
-- ORNEK13:  isminde a harfi olmayanları listeleyiniz
select * from personel where isim not like '%a%';

-- ORNEK14:  ismi A ile başlamayanları listeleyiniz
select * from personel where isim not like 'a%';

-- ORNEK15: maaşı 5 haneli olanları listeleyiniz
select * from personel where maas like '_____'; 

-- ORNEK16: 1. harfi A ve 7.harfi A olan perspneli listeleyiniz.
...
CREATE TABLE kelimeler
    ...
    INSERT INTO kelimeler VALUES (1015, 'hooot', 5);
    
    DROP TABLE kelimeler;

/* -----------------------------------------------------------------------------
  ORNEK1: İçerisinde 'ot' veya 'at' bulunan kelimeleri küçük harfe dikkat
  ederek listeleyiniz 
 -----------------------------------------------------------------------------*/ 
...
/* -----------------------------------------------------------------------------
  ORNEK2: İçerisinde 'ot' veya 'at' bulunan kelimeleri büyük-küçük harfe dikkat
  etmeksizin listeleyeniz
 -----------------------------------------------------------------------------*/ 
    select * from kelimeler where REGEXP_LIKE(kelime, 'at|ot');
   
 /* -----------------------------------------------------------------------------
  ORNEK3: 'ho' veya 'hi' ile başlayan kelimeleri büyük-küçük harfe dikkat
  etmeksizin listeleyeniz
 -----------------------------------------------------------------------------*/   
