...
==============================================================================*/
    ...
    -- ornek1: ismi null olanlari sorgula
...
-----------------------------------------------------------------------------*/ 
	select * from kisiler where soyisim='bulut' order by 5;-- 5:maas
    
-- *****************************LIMIT**************************************
-- listeden ilk 10 veriyi getir
select * from kisiler limit 10;
-- 10. veriden sonraki 2 veriyi al(11 ve 12)
select * from kisiler limit 10,2; -- ilk sayi dahil degil 11 den basla, 2.say kadar ggit
select * from kisiler where id>5 limit 2;-- idsi 5 den buyuk 2 satir
/* ----------------------------------------------------------------------------
...
-----------------------------------------------------------------------------*/
select * from kisiler order by maas limit 2;
/* ----------------------------------------------------------------------------
